...
(
        ...
        sudo bash -c 'chroot . apt-mark hold snapd ubuntu-desktop linux-raspi linux-firmware-raspi2 rpi-eeprom u-boot-rpi'
        sudo bash -c 'chroot . apt -y dist-upgrade'
        sudo bash -c 'chroot . apt -y install linux-firmware ubuntu-desktop'
